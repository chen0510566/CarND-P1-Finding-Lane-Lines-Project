...
def process_image(img):
    ...
    hough_img = hough_lines(sub_img, 1, 3.14 / 180, 40, 10, 20)
    line_img = gaussian_blur(hough_img, 5)
    wig_img = weighted_img(raw_img, line_img, 1.0)
    return cv2.cvtColor(wig_img, cv2.COLOR_BGR2RGB)
